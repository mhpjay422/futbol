...
games_teams_path = './data/game_teams.csv'

locations = {
  games: game_path,
  teams: team_path,
  game_teams: games_teams_path
}
...
puts avg_wins_percent = stat_tracker.average_win_percentage(6)
puts most_goals_for_team = stat_tracker.most_goals_scored(6)
puts least_goals_for_team = stat_tracker.fewest_goals_scored(9)
