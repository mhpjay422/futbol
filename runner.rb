...
# puts worst_wins_coach = stat_tracker.worst_coach(20122013, all_game_teams)
# puts worst_wins_coach = stat_tracker.worst_coach(20132014, all_game_teams)
# puts worst_wins_coach = stat_tracker.worst_coach(20142015, all_game_teams)
# puts best_shot_ratio_team = stat_tracker.most_accurate_team(20122013, all_game_teams)
# puts best_shot_ratio_team = stat_tracker.most_accurate_team(20132014, all_game_teams)
# puts best_shot_ratio_team = stat_tracker.most_accurate_team(20142015, all_game_teams)
# puts worst_shot_ratio_team = stat_tracker.least_accurate_team(20122013, all_game_teams)
# puts worst_shot_ratio_team = stat_tracker.least_accurate_team(20132014, all_game_teams)
